                    ...
                    <div className="card">
                        ...
                        <form>
                            ...
                            <div className="form-floating mb-3 mt-1">
                                ...
                                <div id="emailHelp" class="form-text text-dark"><li>name@example.com</li></div>
                            </div>
                            <div className="form-floating mb-3 mt-1">
                                <input type="password" className="form-control" id="floatingPassword" placeholder="Password"/>
                                <label for="floatingPassword">Password</label>
                                <div id="passwordHelpBlock" class="form-text fw-bold text-danger">
                            ...
                            <div className="form-floating mb-3 mt-1">
                                ...
                                <div id="textHelp" class="form-text text-dark">python,css,java, etc.</div>
                            </div>
