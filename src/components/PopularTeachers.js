...
function PopularTeachers() {
  ...
  return(
    ...
    {teacher.map((name, index) => 
        ...
        <Link to={`/teacher-detail/${teacher[index].id}`}>
          {teacher[index].pic === null && <img src="teacher.png" className="card-img-top" alt="..." />}
        {teacher[index].pic !== null && <img src={`http://127.0.0.1:8000/${teacher[index].pic}`} className="card-img-top" alt="..." />}</Link>
